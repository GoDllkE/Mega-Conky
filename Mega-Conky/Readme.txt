...
Installation Setup)
    ...
    1 - After installing the conky with lua support, run the "install.sh" script, it will do the trick for us.

    2 - Change line 392 in "script.lua" inside de "Script" folder to set the image work. (keep the absolute path please).
